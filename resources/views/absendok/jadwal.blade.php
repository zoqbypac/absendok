                        ...
                        <form action="{{ route('jadwalcuti') }}" method="post">
                            ...
                            <div class="form">
                                ...
                                <input type="date" name="tglawal" id="tglawal"
                                       value="{{ request()->get('tglawal') ?? date('Y-m-d')}}"
                                       class="input input-bordered"> s.d.
                                <input type="date" name="tglakhir" id="tglakhir"
                                       value="{{ request()->get('tglakhir') ?? date('Y-m-d')}}"
                            ...
                            <div class="form-control">
                                ...
                                <datalist id="namadokters">
                                    @foreach ($absensi as $n)
                                        ...
                                        <option
                                            value="{{ $n->absenid }} | {{ $n->namadokter }} | {{ $n->hari }} : {{ $n->jam_mulai }}-{{ $n->jam_selesai }}">
                                    @endforeach
                                </datalist>
                            </div>
                            <div class="modal-action">
                    ...
                    <div class="modal-box">
                        <form action="{{ route('hapusjadwal') }}" method="get">
                            <div class="form-control">
                                ...
                                <label class="label">
                                    <span
                                        class="label-text">Anda Yakin Ingin Menghapus Jadwal? Ketik ini: <strong>{{ $random }}</strong> </span>
                                </label>
                            ...
                            <table id="app" class="table">
                                ...
                                @foreach ($jadwal as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('ubahjadwal',$item->jadwalid) }}"
                                               class="btn btn-sm btn-info">Ubah</a>
                                            <a href="{{ route('xhapusjadwal',$item->jadwalid) }}"
                                               class="btn btn-sm btn-secondary"
                                               onclick="return confirm('Anda yakin ingin menghapus jadwal dokter ini?') ">Hapus</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
                                        ...
                                        <td>
                                            <form action="{{ route('hapuscuti') }}" method="get">
                                                ...
                                                <button type="submit" class="btn btn-sm btn-secondary"
                                                        onclick="return confirm('Anda yakin ingin menghapus cuti {{ $item->namadokter }}?') ">
                                                    Hapus
                                                </button>
                                            </form>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('hapuscuti') }}" method="get">
                                                ...
                                                <button type="submit" class="btn btn-sm btn-secondary"
                                                        onclick="return confirm('Anda yakin ingin menghapus TP {{ $item->namadokter }}?') ">
                                                    Hapus
                                                </button>
                                            </form>
                                        </td>
