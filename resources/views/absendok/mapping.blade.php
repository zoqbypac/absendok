                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('mappingstore') }}" method="post">
                                                ...
                                                <button type="submit" name='kategori' value="Eksekutif"
                                                        class="btn btn-sm btn-accent">Eksekutif
                                                </button>
                                                <button type="submit" name='kategori' value="Reguler"
                                                        class="btn btn-sm btn-info">Reguler
                                                </button>
                                            </form>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('mappingstore') }}" method="post">
                                                ...
                                                <input type="hidden" name="id" value="{{ $item->mapid }}">
                                                <button type="submit" name='kategori' value="Reguler"
                                                        class="btn btn-sm btn-info">Pindah
                                                </button>
                                                <button type="submit" name='kategori' value="x"
                                                        class="btn btn-sm btn-secondary">X
                                                </button>
                                            </form>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('mappingstore') }}" method="post">
                                                ...
                                                <input type="hidden" name="id" value="{{ $item->mapid }}">
                                                <button type="submit" name='kategori' value="Eksekutif"
                                                        class="btn btn-sm btn-accent">Pindah
                                                </button>
                                                <button type="submit" name='kategori' value="x"
                                                        class="btn btn-sm btn-secondary">X
                                                </button>
